    ...
    <>
      <div className="hero">
        ...
        <div className="dotdiv">
          <span
            className={`dot ` + (currentImageIndex === 0 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 1 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 2 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 3 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 4 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 5 ? "dotactive" : "")}
          ></span>
          <span
            className={`dot ` + (currentImageIndex === 6 ? "dotactive" : "")}
          ></span>
        </div>
      </div>
